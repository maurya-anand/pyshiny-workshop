...
This is the workshop originally prepared for [posit::conf 2023](https://posit.co/conference/).
It has been reviewed and updated by [Appsilon](https://appsilon.com/).
...
3)  Clone the repository with `git clone https://github.com/Appsilon/shinyconf-pyshiny-workshop.git`, or alternately download the repository as a zip file: \
